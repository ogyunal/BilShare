package com.bilshare.bilshare.testbench;
...
import com.bilshare.bilshare.testbench.elements.components.OrderCardElement;
import com.bilshare.bilshare.testbench.elements.ui.OrderItemEditorElement;
...
public class StorefrontViewIT extends AbstractIT<StorefrontViewElement> {
	...
	public void editOrder() {
		...
		editBtn.click();
		Assert.assertThat(getDriver().getCurrentUrl(), containsString(BilShareConstants.PAGE_STOREFRONT_EDIT));
