...
import static com.bilshare.bilshare.ui.utils.BilShareConstants.PAGE_PRODUCTS;

@Route(value = PAGE_PRODUCTS, layout = MainView.class)
@PageTitle(BilShareConstants.TITLE_PRODUCTS)
@Secured(Role.ADMIN)
public class ProductsView extends AbstractBakeryCrudView<Product> {
	...
	private static BinderCrudEditor<Product> createForm() {
		...
		String currencySymbol = Currency.getInstance(BilShareConstants.APP_LOCALE).getSymbol();
