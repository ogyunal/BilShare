...
import com.bilshare.bilshare.backend.data.DashboardData;
import com.bilshare.bilshare.backend.data.DeliveryStats;
...
import com.bilshare.bilshare.ui.views.storefront.OrderCard;
import com.bilshare.bilshare.ui.views.storefront.beans.OrdersCountDataWithChart;

@Tag("dashboard-view")
@JsModule("./src/views/dashboard/dashboard-view.js")
@Route(value = BilShareConstants.PAGE_DASHBOARD, layout = MainView.class)
@PageTitle(BilShareConstants.TITLE_DASHBOARD)
