package com.ogyunal.ogulcan.ui.views.storefront;

import static com.ogyunal.ogulcan.ui.utils.FormattingUtils.HOUR_FORMATTER;
import static com.ogyunal.ogulcan.ui.utils.FormattingUtils.MONTH_AND_DAY_FORMATTER;
import static com.ogyunal.ogulcan.ui.utils.FormattingUtils.SHORT_DAY_FORMATTER;
import static com.ogyunal.ogulcan.ui.utils.FormattingUtils.WEEKDAY_FULLNAME_FORMATTER;
import static com.ogyunal.ogulcan.ui.utils.FormattingUtils.WEEK_OF_YEAR_FIELD;
...
import com.ogyunal.ogulcan.backend.data.entity.OrderItem;
import com.ogyunal.ogulcan.backend.data.entity.OrderSummary;
import com.ogyunal.ogulcan.ui.utils.converters.OrderStateConverter;
