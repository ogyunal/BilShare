...
public interface OrderRepository extends JpaRepository<Order, Long> {
	...
	List<Object[]> countPerMonth(OrderImage orderImage, int year);
	...
	List<Object[]> sumPerMonthLastThreeYears(OrderImage orderImage, int year);
	...
	List<Object[]> countPerDay(OrderImage orderImage, int year, int month);
	...
	List<Object[]> countPerProduct(OrderImage orderImage, int year, int month);
