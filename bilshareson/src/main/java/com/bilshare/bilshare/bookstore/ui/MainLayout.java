...
import com.bilshare.bilshare.bookstore.ui.about.AboutView;
import com.bilshare.bilshare.bookstore.ui.inventory.InventoryView;
...
public class MainLayout extends AppLayout implements RouterLayout {
    ...
    public MainLayout() {
        ...
        final String resolvedImage = VaadinService.getCurrent().resolveResource(
                "img/bilshare-logo.png", VaadinSession.getCurrent().getBrowser());


        final Image image = new Image(resolvedImage, "");
        final Label title = new Label("Welcome To Bilshare");
        top.add(image, title);
        addToNavbar(top);
